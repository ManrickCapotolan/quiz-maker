...
export default function QuestionnaireDialog({
  ...
  const handleNext = async () => {
    try {
      ...
      toast.error("Failed to log answer");
    }
  };
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between mt-12">
          <Button
            ...
            disabled={
              isFirstQuestion || logAnswer.isPending || submitAttempt.isPending
            }
          >
            <ChevronLeft />
            Previous
          ...
          >
            {submitAttempt.isPending || logAnswer.isPending
              ? "Submitting..."
              : "Submit"}
            <ChevronRight />
          </Button>
